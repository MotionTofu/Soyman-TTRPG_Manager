 ...
 *
 * Заготовка без принуждения эту судьбу повторяет: `EntityTabWorkspace` написан
 * с внятным комментарием-концепцией и за всё время дошёл до трёх страниц из
 * шестнадцати, а `FloatingActionBar` — ни до одной. Поэтому проверяется
 * механически, как шкала кегля и шага.
 *
