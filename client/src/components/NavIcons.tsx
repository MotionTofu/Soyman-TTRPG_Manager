...
const PATHS: Record<NavIconName, ReactNode> = {
  ...
  // Значки типа строки на вкладке «Действия»: искра — заклинание, sword —
  // оружие, руна — способность, точки — вписанное руками. Одна манера с
  // остальным набором: 24-я сетка, обводка currentColor, без заливки.
  spark: (
    <>
      <path d="M12 3.5c0 4 1.6 6 5.5 6-3.9 0-5.5 2-5.5 6 0-4-1.6-6-5.5-6 3.9 0 5.5-2 5.5-6Z" />
      <path d="M18.6 15.6c0 1.8.8 2.6 2.4 2.6-1.6 0-2.4.8-2.4 2.6 0-1.8-.8-2.6-2.4-2.6 1.6 0 2.4-.8 2.4-2.6Z" />
    </>
  ),
  rune: (
    <>
  ...
  dots: (
    <>
      <circle cx="12" cy="12" r="8.5" />
      <path d="M8.3 12h.01M12 12h.01M15.7 12h.01" strokeWidth="2.4" />
    </>
  ),
  image: (
    <>
