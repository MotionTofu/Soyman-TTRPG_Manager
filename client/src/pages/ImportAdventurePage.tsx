            ...
            <>
              {plan.setting && (
                <div className="card stack">
                  ...
                  <div className="muted">
                    Существующее книга не переписывает, но дозаливает недостающее: пустое поле
                    заполнится тем, что есть в файле, а у существа без карточки статблока она
                    появится. Заполненное остаётся как было.
                  </div>
                </div>
              )}
