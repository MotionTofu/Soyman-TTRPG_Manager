...
/**
 * Сессия изменилась с главной: сама сессия, её кампания, календарь и сводка
 * денег. Календарь и деньги задевает и общее правило сессии (data/entities.ts);
 * здесь они названы явно — главная показывает именно их.
 */
