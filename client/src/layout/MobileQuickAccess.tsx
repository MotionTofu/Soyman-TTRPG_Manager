...
// spec.md §"Мобильная навигация"): pinned pages (same usePinnedPages/MAX_PINS
// mechanism the desktop NavWidget/SearchPanel use — pinning here shows up
// there too, same localStorage-backed store), a "pin current page" action,
// and an optional contextual action for the current screen.
