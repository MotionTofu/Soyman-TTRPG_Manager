...
async function main() {
  ...
  // Журнал медленных запросов и ошибок: кто, с какого устройства и на каком
  // экране работал — личное целиком, в установщик не едет ни строки.
  db.exec("DELETE FROM client_journal");
