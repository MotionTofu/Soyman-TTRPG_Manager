...
Когда ниже приложен **список уже занятых ключей** (строки вида `loc.blue_alley — Синий
переулок (локация)`), это значит, что предыдущие части книги уже загружены. Тогда:
...
- Если сущность из списка описана в новой части существенно подробнее, всё равно не
  дублируй её: положи новое содержимое в те сцены и главы, где оно встретилось.
...
- Если список занятых ключей приложен: ни одна сущность из него не объявлена заново, и ни
  один её ключ не переписан по-своему.
