...
**Комната подземелья — это и локация, и сцена, всегда обе.** Локация описывает само место:
из чего сложены стены, что там стоит, что написано на стене — то, что верно всегда. Сцена
описывает происходящее: что срабатывает, кто нападает, что можно найти, какие броски
нужны. У локации и сцены могут быть одинаковые названия, это нормально. Сцена обязана
ссылаться на свою локацию через `locations`. Не пытайся уместить всё в одно: описание
места без сцены нечего отыгрывать, сцена без места некуда поставить на карте.
...
- `read_aloud` — **каждый** выделенный в книге блок текста для зачитывания, дословно. Это
...
- Каждый выделенный блок для зачитывания попал в `read_aloud` дословно.
